...
If you get an error like this `npm ERR! code EACCES`
go this link to change your usr file permissions. It helped me not have to use `sudo` everytime I install global node packages. 
